...
export default function Disclaimer({ isMobile }) {
  ...
  return (
    <div
      ...
      style={{
        ...
        padding: isMobile ? '5px 12px' : '7px 14px',
        font: `${isMobile ? 11 : 12}px/1.4 ${MONO}`, color: '#5b5348',
    ...
    >
      <span style={{ flex: 1, minWidth: 0 }}>
        ...
        {isMobile
          ? '. Provisional — verify before citing.'
